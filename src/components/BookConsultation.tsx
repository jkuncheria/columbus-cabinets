              ...
              <div className="grid md:grid-cols-2 gap-0">
                ...
                <div className="bg-background p-8 md:p-12 flex flex-col justify-center">
                  ...
                  <p className="text-lg text-muted-foreground mb-6">
                    Are you looking to transform your kitchen or bathroom with beautiful, functional cabinets? Whether you're building new, 
                    remodeling, or upgrading your rental property, we're here to help. Visit our showroom or call us now for expert guidance.
                  </p>
